...
namespace AnnoMapEditor.Models
{
    public struct Region
    {
        ...
        public static readonly Region Moderate = new("Moderate",
            new()
            {
        ...
        public static readonly Region NewWorld = new("NewWorld",
            new()
            {
        ...
        public static readonly Region Arctic = new("Arctic",
            new()
            {
        ...
        public static readonly Region Enbesa = new("Enbesa",
            new()
            {
        ...
        private Region(string type, Dictionary<IslandSize, Pool> poolIslands)
        {
            value = type;
