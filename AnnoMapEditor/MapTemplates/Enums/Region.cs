...
namespace AnnoMapEditor.MapTemplates.Enums
{
    public class Region
    {
        ...
        public static readonly Region Moderate = new(5000000, "Moderate", "Moderate_01_day_night", allowModding:true, "moderate",
            new[] { "ll", "lm", "ls", "ml", "mm", "ms", "sl", "sm", "ss" },
            new[] { "01", "02" },
            usesAllSizeIndices:false, hasMapExtension:false);

        public static readonly Region NewWorld = new(5000001, "New World", "south_america_caribic_01", allowModding: true, "colony01", 
            new[] { "s", "m", "l"},
            new[] { "01", "02", "03" },
        ...
        public static readonly Region Arctic = new(160001, "Arctic", "DLC03_01", allowModding: false, poolFolderName:"colony03",
            new[] { "sp" },
            new[] { "" },
            usesAllSizeIndices: true, hasMapExtension: false);

        public static readonly Region Enbesa = new(114327, "Enbesa", "Colony_02", allowModding: false, "land_of_lions",
            new[] { "01" },
            new[] { "", "mp" },
            usesAllSizeIndices: true, hasMapExtension: false);
        ...
        private Region(long assetGuid, string name, string ambientName, bool allowModding, string poolFolderName, 
